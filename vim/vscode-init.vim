"This is to be used for vscode-neovim for VSCode
...
" copy visual selection to vscode clipboard
vnoremap <leader>y <CMD>call VSCodeNotifyVisual('editor.action.clipboardCopyAction', 0)<CR>
