...
plugins=(zsh-syntax-highlighting zsh-autosuggestions vi-mode fzf sudo z brew tmux git mosh)
...
export HISTSIZE=62428800
export SAVEHIST=$HISTSIZE
export LESSHISTFILE=-



[ -f ~/.fzf/bin/fzf ] && chmod +x ~/.fzf/bin/fzf
